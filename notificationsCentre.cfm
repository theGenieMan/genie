	...
	<cfoutput>	 
	   <cfloop from="1" to="#ArrayLen(userMessages2.nominals)#" index="iNom">
		...
		<div class="notification" nominalRef="#userMessages2.nominals[iNom].nominal.getNOMINAL_REF()#">		
			...
			<div class="ncPhoto">
			 <a href="/redirector/redirector.cfm?type=nominal&ref=#userMessages2.nominals[iNom].nominal.getNOMINAL_REF()#&auditRequired=IFNOTSET" target="_blank">
			  <img src="#userMessages2.nominals[iNom].nominal.getLATEST_PHOTO().getPHOTO_URL()#" width="100" border="0" />
			 </a>
			</div>
			<div class="ncUpdateContainer">
			  <span><b><a href="/redirector/redirector.cfm?type=nominal&ref=#userMessages2.nominals[iNom].nominal.getNOMINAL_REF()#&auditRequired=IFNOTSET" target="_blank">#userMessages2.nominals[iNom].nominal.getFORENAME_1()# #userMessages2.nominals[iNom].nominal.getSURNAME_1()##iif(Len(userMessages2.nominals[iNom].nominal.getSURNAME_2()) GT 0,de('-'&userMessages2.nominals[iNom].nominal.getSURNAME_2()),de(''))#</a></b> ( <img src="/images/minus.gif" align="absmiddle" nominalRef="#userMessages2.nominals[iNom].nominal.getNOMINAL_REF()#" class="notificationDismissAll"> <b>All</b> )</span><br>
			  <div class="ncUpdates">		  		  
				 ...
				 <div class="ncUpdate" nominalRef="#userMessages2.nominals[iNom].nominal.getNOMINAL_REF()#" updateInfo="#updateInfo#">
				  <img src="/images/minus.gif" align="absmiddle" class="notificationDismiss" updateInfo="#updateInfo#"> #DateFormat(userMessages2.nominals[iNom].nominal.updates[iUpd].timestamp,"DDD DD-MMM")#: #userMessages2.nominals[iNom].nominal.updates[iUpd].html#<br>
				 </div>  	
				</cfloop>		  
			  </div>
			</div>
