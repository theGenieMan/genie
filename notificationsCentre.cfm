	...
	<cfoutput>	 
	   <cfloop from="1" to="#ArrayLen(userMessages2.nominals)#" index="iNom">
		...
		<div class="notification" nominalRef="#userMessages2.nominals[iNom].nominal.getNOMINAL_REF()#">		
			...
			<div class="ncPhoto">
			 <a href="#userMessages2.nominals[iNom].nominal.getNOMINAL_REF()#" dpa="yes" class="genieNominal">
			  <img src="#userMessages2.nominals[iNom].nominal.getLATEST_PHOTO().getPHOTO_URL()#" width="100" border="0" />
			 </a>
			</div>
			<div class="ncUpdateContainer">
			  <span><b><a href="#userMessages2.nominals[iNom].nominal.getNOMINAL_REF()#" dpa="yes" class="genieNominal">#userMessages2.nominals[iNom].nominal.getFORENAME_1()# #userMessages2.nominals[iNom].nominal.getSURNAME_1()##iif(Len(userMessages2.nominals[iNom].nominal.getSURNAME_2()) GT 0,de('-'&userMessages2.nominals[iNom].nominal.getSURNAME_2()),de(''))#</a></b> ( <img src="/images/minus.gif" align="absmiddle" nominalRef="#userMessages2.nominals[iNom].nominal.getNOMINAL_REF()#" class="notificationDismissAll"> <b>All</b> )</span><br>
			  <div class="ncUpdates">		  		  
				 ...
				 <div class="ncUpdate" nominalRef="#userMessages2.nominals[iNom].nominal.getNOMINAL_REF()#" updateInfo="#updateInfo#">
				  ...
				  <a href="#userMessages2.nominals[iNom].nominal.updates[iUpd].href#" #userMessages2.nominals[iNom].nominal.updates[iUpd].additionalAttributes# class="#userMessages2.nominals[iNom].nominal.updates[iUpd].jQueryClass#" dpa="true">#userMessages2.nominals[iNom].nominal.updates[iUpd].DISPLAYDATA#</a><br>
				 </div>  	
				</cfloop>		  
			  </div>
			</div>
