...
<cfscript>
	...
	config.userFilesPath = "/genie_data/ckEditor/";
    
	//config.serverPath = '\\svr20200\g$\genie_data\intelPackages\'; // use this to force the server path if FCKeditor is not running directly off the root of the application or the FCKeditor directory in the URL is a virtual directory or a symbolic link / junction
    // now done below!
...
<cfif SERVER_NAME IS "genie.intranet.wmcpolice">
	<cfset config.serverPath='\\svr20200\g$\genie_data\ckeditor\'>
<cfelseif SERVER_NAME IS "SVR20312">
	<cfset config.serverPath='\\svr20312\d$\genie_data\ckeditor\'>
</cfif>	
