...
<cfscript>
	...
	config.userFilesPath = "/assets/briefings/";

	config.serverPath = 'd:/assets/briefings/'; // use this to force the server path if FCKeditor is not running directly off the root of the application or the FCKeditor directory in the URL is a virtual directory or a symbolic link / junction
