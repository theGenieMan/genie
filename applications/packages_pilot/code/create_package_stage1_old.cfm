...
<div align="center" style="font-size:120%; font-weight:bold; padding-top:3px">Create New Package - Stage 1 - Package Information</div>
 ...
 <tr>
   ...
   <td width="49%" valign="top">
     <table width="100%" style="margin:0px;">
	  <tr>
		 <td width="37%" valign="top"><label for="frm_SelCauses">Causes</label> *</td>
		 <td>
      ...
      <tr>
       ...
       <td><textarea name="frm_TxtNotes" rows="2" cols="30">#frm_TxtNotes#</textarea></td>
     </tr>		
	  <tr>
