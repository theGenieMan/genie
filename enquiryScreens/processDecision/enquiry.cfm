		...
		<div class="ui-widget-content ui-accordion-content searchPaneContent">
			<table width="98%" align="center">
		  		<tr>
					...
					<td width="30%">
						<input name="pd_ref" id="pd_ref" displayInPane="Process No" size="15" value="">
					</td>
					<td width="5%">&nbsp;</td>
					<td width="15%"><label for="case_org">Case No</label></td>
					<td>
						<input name="case_org" id="case_org" displayInPane="Case Org" size="4" value="">
						/
						<input name="case_serial" id="case_serial" displayInPane="Case Serial" size="7" value="">
						/
						<input name="case_year" id="case_year" displayInPane="Case Year" size="2" value="">
					</td>										
		  		</tr>		
				<tr>
					<td><label for="custody_ref">Custody No</label></td>
					<td>
						<input name="custody_ref" id="custody_ref" displayInPane="Custody No" size="12" value="">
					</td>	
					<td>&nbsp;</td>	
					<td><label for="decision">Decision</label></td>
					<td>
						<input name="decision" id="decision" displayInPane="Decision" size="20" value="">
					</td>								
				</tr>	
				<tr>
					<td><label for="nominal_ref">Nominal Ref</label></td>
					<td>
						<input name="nominal_ref" id="nominal_ref" displayInPane="Nominal Ref" size="10" value="">
					</td>	
					<td>&nbsp;</td>	
					<td><label for="arrest_summons_no">Arrest Summons No</label></td>
					<td>
						<input name="arrest_summons_no" id="arrest_summons_no" displayInPane="Arrest Summons No" size="15" value="">
					</td>								
				</tr>					
				<tr>
					...
					<td colspan="4">
						<b>Between/On</b> 
						<input name="date_form1" id="date_form1" displayInPane="Formalised Between/On" size="10" value="" datepicker> 
						<b>And</b> 
						<input name="date_form2" id="date_form2" displayInPane="Formalised To" size="10" value="" datepicker>
					</td>										
				</tr>	
		  	</table>			
		</div>
