...
Module      : /enquiryScreens/intelByArea/enquiry.cfm

App         : GENIE

Purpose     : Displays the intel by area enquiry screen
...
<cfparam name="area" default="PAD05">
<cfparam name="dateFrom" default="01/02/2015">
<cfparam name="dateTo" default="04/02/2015">	
	
<html>	
<head>
	<title>GENIE - Intel By Area Enquiry</title>
	...
	<script type="text/javascript" src="js/intelByAreaFunctions.js"></script>
	<script type="text/javascript" src="js/intelByAreaEvents.js"></script>
...
<body>
	...
	<cfset headerTitle="INTEL BY AREA">	
	...
	<div id="searchPanes">	  
	  <div class="ui-state-highlight" align="center">
		Enter information into <b>ALL</b> of the search fields below.
	  </div>
	  ...
	  <div id="referencePane" class="ui-accordion searchPane" initOpen="true">
		...
		<div class="ui-widget-content ui-accordion-content searchPaneContent">
			<table width="98%" align="center">
		  		<tr>
		  			<td valign="top" width="15%"><label for="dateFrom">Date From</label></td>
					<td  valign="top">
						<input name="dateFrom" id="dateFrom" displayInPane="Date From" displayPrevSearch="Y" datepicker size="15" class="mandatory" value="#dateFrom#">
					</td>															
		  		</tr>
				<tr>
		  			<td valign="top"><label for="dateTo">Date To</label></td>
					<td  valign="top">
						<input name="dateTo" id="dateTo" displayInPane="Date From" displayPrevSearch="Y" datepicker size="15" class="mandatory" value="#dateTo#">
					</td>															
		  		</tr>
				<tr>
		  			<td valign="top"><label for="area">Area</label></td>
					<td  valign="top">
						<select name="area" id="area" class="mandatory" displayInPane="Area" displayPrevSearch="Y">
						  <option value="">-- Select --</option>
						  <cfloop query="application.qSNTs">
						  	  <option value="#SNT_CODE#" #iif(ListFind(area,SNT_CODE,",") GT 0,de('selected'),de(''))#>#SNT_CODE# - #SNT_NAME#</option>
						  </cfloop>
						</select>		
					</td>															
		  		</tr>																	
