		...
		<div class="ui-widget-content ui-accordion-content searchPaneContent">
			<table width="98%" align="center">
				...
				<tr>
					...
					<td  valign="top">
						<input name="category_code" id="category_code" displayInPane="Category" size="5" value="" readonly>						
					...
					<td  valign="top">
						<input name="subCategory_code" id="subCategory_code" displayInPane="Sub Category" size="5" value="" readonly>						
				...
				<tr>
					...
					<td  valign="top">
						<input name="manufacturer_code" id="manufacturer_code" displayInPane="Manufacturer" size="5" value="" readonly>						
					...
					<td  valign="top">
						<input name="model_code" id="model_code" displayInPane="Model" size="5" value="" readonly>						
				...
				<tr>
					...
					<td valign="top">
						<select name="prop_type" id="prop_type" displayInPane="Type">
					...
					<td valign="top">
						<input type="text" name="notes" id="notes" size="30" displayInPane="Notes">
					</td>								
				</tr>				
				<tr>
					<td valign="top"><label for="vrm">VRM</label></td>
					<td valign="top">
						<input type="text" name="vrm" id="vrm" size="12" displayInPane="VRM">
					</td>	
					<td>&nbsp;</td>						
					<td valign="top"><label for="card_no">Card No</label></td>
					<td valign="top">
						<input type="text" name="card_no" id="card_no" size="30" displayInPane="Card No">
					</td>								
				</tr>			
				<tr>
					<td valign="top"><label for="unique_id">Unique ID</label></td>
					<td valign="top">
						<input type="text" name="unique_id" id="unique_id" size="30" displayInPane="Unique ID">
					</td>	
					<td>&nbsp;</td>						
					<td valign="top"><label for="other_marks">Other Marks</label></td>
					<td valign="top">
						<input type="text" name="other_marks" id="other_marks" size="30" displayInPane="Other Marks">
					</td>								
				</tr>				
				<tr>
				...
				<tr>
					...
					<td valign="top" colspan="4">						
						<select name="usage" id="usage" displayInPane="Type">
							<option value="">-- Select --</option>							
