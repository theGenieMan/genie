		...
		$('#dpa').dpa({
					...
					dpaUpdated: function(e,data){
	                        ...
	                        var auditString  = '&userId='+data.requestForUserId;
								...
								auditString += '&action=View Custody';
								auditString += '&details='+custodyRef;
...
<div id="custodyDocumentBody" style="display:none;">
...
<input type="hidden" name="custodyRef" id="custodyRef" value="#custodyRef#">
</cfoutput>
