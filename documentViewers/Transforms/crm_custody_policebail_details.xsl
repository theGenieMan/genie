...
<xsl:template match="/">
<xsl:for-each select="Custody_Document/Police_Bails/Bail_Ref">
 ...
 <div style="width:100%; border:1px solid; padding:2px">
  ...
  <tr>   
   ...
   <td colspan="4">  
   <b><xsl:value-of select="Offence_Detail" /></b>
   </td>
  </tr>  
  <tr>
   <td>
  ...
  <tr>
   ...
   <td>
   <b><xsl:value-of select="Station_Bailed_To" /></b>   
   </td>
   <td>&nbsp;</td>   
   <td>Date/Time</td>
   <td>
  ...
  <tr>
   <td>Bail Answered</td>
   <td> <b><xsl:value-of select="Bail_Answered" /></b> </td>
   <td>&nbsp;</td>   
   <td>Cancel Reason</td>
   <td> <b><xsl:value-of select="Cancel_Reason" /></b> </td>
  </tr>
  <tr>
   <td valign="top">Conditions</td>
   <td valign="top"> <b><xsl:value-of select="Conditions" /></b> </td>
   <td>&nbsp;</td>   
   <td valign="top">Reason</td>
   <td valign="top"> <b><xsl:value-of select="Reason" /></b> </td>
  </tr>
  </table>
 </div>
<br />
